...
$('.p1-4_content').each(function () {
    var $table = $(this);
    var itemsPerPage = 16;
    var currentPage = 0;
    var pages = Math.ceil($table.find(".square").length / itemsPerPage);
    ...
    $table.find(
    '.square').hide().slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage).show();
    });
